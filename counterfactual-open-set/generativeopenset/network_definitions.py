...
class generator256(nn.Module):
    ...
    def __init__(self, latent_size=100, batch_size=64, **kwargs):
        ...
        self.conv7 = nn.ConvTranspose2d(32, 16, 4, stride=2, padding=1)
        self.conv8 = nn.ConvTranspose2d(16, 3, 4, stride=2, padding=1)
...
class multiclassDiscriminator256(nn.Module):
    def __init__(self, latent_size=100, num_classes=2, batch_size=64, **kwargs):
        super(self.__class__, self).__init__()
        self.batch_size = batch_size
        self.num_classes = num_classes
        ...
        self.fc1 = nn.Linear(262144, num_classes)  # Correcting to match the actual output size from the conv layers
        self.dr1 = nn.Dropout2d(0.2)
        self.dr2 = nn.Dropout2d(0.2)
        self.dr3 = nn.Dropout2d(0.2)
